<script lang="ts">
	...
	import { File, ListFilter, Ellipsis, CirclePlus } from 'lucide-svelte';
	...
	onMount(async () => {
		products = (await axios.get('https://fakestoreapi.com/products')).data;
	});
</script>
...
<div class="flex flex-col sm:gap-4 sm:py-4">
	<main class="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8">
		<Tabs.Root class="" value="all">
			...
			<Tabs.Content class="" value="all">
				<Card.Root class="h-[80dvh] overflow-auto">
					<Card.Header>
								...
								{#each products as product}
									<Table.Row>
										<Table.Cell class="hidden sm:table-cell">
											<img
												alt="Product example"
												class="aspect-square rounded-md object-fill"
												height="64"
												src={product.image}
												width="64"
											/>
										...
										<Table.Cell class="hidden md:table-cell"
											>{Math.floor(Math.random() * 100)}</Table.Cell
										>
										...
										<Table.Cell>
											<DropdownMenu.Root>
												...
												<DropdownMenu.Content align="end">
													...
													<DropdownMenu.Item>
														<a class="w-full" href="/admin/products/edit"> Edit</a>
													</DropdownMenu.Item>
